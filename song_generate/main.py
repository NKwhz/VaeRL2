...
def get_latent(model, doc, pho):
    return model.predict([doc, pho])
...
for create_model in create_models:
    ...
    for song_indx, start_line in enumerate(start):
        ...
        while length < create_song_length:
            ...
            rank = get_latent(asvae, feature_vector, feature_vector3)
